MiaFuzzer is a script designed to 'fuzz' a website (bruteforce the file directory) made because I didn't particularily like the layout of
other fuzzing programs.
